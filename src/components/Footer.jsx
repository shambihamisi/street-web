      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="hidden sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <p className="text-white mb-4 sm:mb-6 max-w-xs mx-auto sm:mx-0 text-sm sm:text-base">
              Get design that builds trust. Get visuals that fit your audience.
            </p>
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              <a
                ...
                className="p-2 sm:p-2.5 bg-white rounded-lg hover:bg-stone-300 transition-colors duration-200"
              >
                <Twitter className="w-5 h-5 sm:w-5 sm:h-5" />
              </a>
              <a
                href="https://github.com/shambihamisi"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 sm:p-2.5 bg-white rounded-lg hover:bg-stone-300 transition-colors duration-200"
              >
        ...
        <div className="pt-6 sm:pt-8 border-t-0 sm:border-t border-neutral-800">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <p className="text-gray-400 text-xs sm:text-sm">
              © 2025 Street. All rights reserved.
            </p>
